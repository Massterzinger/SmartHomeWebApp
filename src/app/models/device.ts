...
export class DeviceValue implements IDeviceValue {
    ...
    constructor(caption: string, type: string, value: any = null, action?: IDeviceAction) {
...
export class DeviceAction implements IDeviceAction {
    constructor(public actionEndpoint: string, public value?: any, public applicables?: any) { }
}
